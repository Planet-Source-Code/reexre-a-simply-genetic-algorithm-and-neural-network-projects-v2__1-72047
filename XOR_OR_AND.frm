VERSION 5.00
Begin VB.Form Form1 
   Caption         =   "Train NN with GA for XOR OR & AND functions"
   ClientHeight    =   7290
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   9780
        ...
        If GA.IsIndiChanged(I) Then
            ...
            For I1 = 0 To 1
                For I2 = 0 To 1
                    ...
                    O = BrainPOP.RUN(I, 2, Array(I1, I2))
                    f = f + Abs(O(1) - (I1 Or I2))
                    O = BrainPOP.RUN(I, 3, Array(I1, I2))
                    f = f + Abs(O(1) - (I1 And I2))
...
Print "  " & I1 & "  XOR  " & I2 & "  =  " & O(1)
O = BrainPOP.RUN(Best, 2, Array(I1, I2))
Print "  " & I1 & "  OR  " & I2 & "  =  " & O(1)
O = BrainPOP.RUN(Best, 3, Array(I1, I2))
Print "  " & I1 & "  AND  " & I2 & "  =  " & O(1)
...
BrainPOP.InitBrains 50, 3
BrainPOP.InitBrainCell 1, Array(2, 5, 1), 10 '2 inputs '5 hidden '1 output
BrainPOP.InitBrainCell 2, Array(2, 2, 1), 10
BrainPOP.InitBrainCell 3, Array(2, 2, 1), 10
